id: qoi2yryji7rsctnfu5bn2eqs64ppfyeh5er96mhnwm5wa4tn
name: openssl
license: Apache License 2.0
description: Zig bindings for quictls/openssl
root_dependencies:
dependencies:
  - src: git https://github.com/quictls/openssl.git
    version: OpenSSL_1_1_1m+quic
    c_include_dirs:
      - include
      - src
    c_source_flags:
