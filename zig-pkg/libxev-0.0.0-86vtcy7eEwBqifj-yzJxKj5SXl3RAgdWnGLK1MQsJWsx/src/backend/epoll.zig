...
pub const AcceptError = posix.Error || error{
    DupFailed,
    Unknown,
};

pub const CloseError = posix.Error || ThreadPoolError || error{
    Unknown,
};

pub const PollError = posix.Error || error{
    DupFailed,
    Unknown,
};
...
pub const ConnectError = posix.Error || error{
    DupFailed,
    Unknown,
};

pub const ReadError = ThreadPoolError || posix.Error || error{
    DupFailed,
    EOF,
    Unknown,
};

pub const WriteError = ThreadPoolError || posix.Error || error{
    DupFailed,
    Unknown,
};
